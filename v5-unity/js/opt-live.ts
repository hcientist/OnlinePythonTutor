...
- look into interactions between parseQueryString for pre-loaded URLs
  and the auto-re-execution feature, ergh ...

  - ERGH if you preload with curInstr, it jumps to the end since it
    executes multiple times at the beginning, ERGH!
