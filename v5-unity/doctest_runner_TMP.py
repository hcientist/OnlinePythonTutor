...
Output (if you pass in, say, lab1.py to this script):
- lab1_skeleton.py - a skeleton lab file with docstrings stripped out
- lab1_doctests.pickle - a pickle file containing a list of
  doctest.DocTest objects parsed from lab1.py
  - the first element contains the docstring for the top-level module
    (which you can parse to get a lab overview description); all
