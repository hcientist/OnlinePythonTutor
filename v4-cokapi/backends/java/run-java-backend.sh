...
# old memory value: -Xmx512m
#
# OK, my current folk hypothesis is that the InMemory process should
# *not* be given a lot of RAM, since that will simply eat up the limited
# RAM quota in the docker container available to the child tracer process
# that it launches!
